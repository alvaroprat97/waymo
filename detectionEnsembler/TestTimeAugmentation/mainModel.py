...
def models(listaModels, pathImg, option, conf_list = [0.5, 0.5, 0.5]):
    ...
    # 4. Generate xml
    for idx, model in enumerate(listaModels):
        ...
        for dir in os.listdir(pathImg+'/../salida/'):
            if (os.path.splitext(os.path.basename(pathImg+'/../salida/'+model.pathPesos))[0]) == dir:
                ...
                model.predict(pathImg+'/../salida/'+dir, pathImg+'/../salida/'+dir, conf_list[idx])
...
if __name__== "__main__":
    ...
    # TODO [] = weightPath, fichNames, fichCfg
    config_paths = {'ED':[],
#                     'rCNN':[],
#                     'MaskRCNN':[],
#                     'YOLO':[]
    ...
    WaymoEfficientDet = testTimeAugmentation.WaymoEfficientDet(*config_paths['ED'])
#     WaymoRCNN = testTimeAugmentation.WaymoRCNN(*config_paths['RCNN'])
#     WaymoMaskRCNN = testTimeAugmentation.WaymoMaskRCNN(*config_paths['MaskRCNN'])
#     WaymoYOLO = testTimeAugmentation.WaymoYOLO(*config_paths['YOLO'])
...
#     maskRcnn = testTimeAugmentation.MaskRCNNPred('/home/master/Desktop/peso/mask_rcnn_coco.h5', '../peso/coco.names')
    ...
    listaModels = [WaymoEfficientDet] #, WaymoRCNN, WaymoMaskRCNN, WaymoYOLO]
